...
"""
#%%
def for_letter_list(slis):
    for let in slis:
        print(let)
def for_cap_list(slis):
    for caplet in slis:
        print(caplet)
def for_misc_list(slis):
    for misc in slis:
        print(misc)
...
#%%
def average(nlis):
    sum=0          # sum or sum_ are both correct
    num=len(nlis)
...
"""
"""
Another and simpler solution using the list itself as the interator
"""
#%%
def average1(nlis):
    sum=0
...
#%%
def diner_waitress():
    print("Hello,I'll be your waitress.What wil you have?")
    order=[]
    while True:
